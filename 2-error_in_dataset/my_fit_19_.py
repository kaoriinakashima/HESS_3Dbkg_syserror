...
from gammapy.modeling.iminuit import (
    confidence_iminuit,
    contour_iminuit,
    covariance_iminuit,
    optimize_iminuit,
)
from gammapy.modeling.scipy import confidence_scipy, optimize_scipy
...
class Fit:
    ...
    def _parse_datasets(datasets):
        import my_dataset_core_19
        #from gammapy.datasets import Datasets

        datasets = my_dataset_core_19.Datasets(datasets)
    ...
    def covariance(self, datasets):
        ...
        with parameters.restore_status():
            ...
            datasets.models.covariance = covariance.get_subcovariance(datasets.models.parameters)
